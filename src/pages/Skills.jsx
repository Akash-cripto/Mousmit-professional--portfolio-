...
function Skills() {
  ...
  const metaDescription = `Mousmit Seth's technical skills include ${technicalSkills.slice(0, 5).map(s => s.name).join(', ')} and more. Professional skills: ${professionalSkills.slice(0, 3).map(s => s.name).join(', ')}.`;
  ...
  return (
    <>
      <Helmet>
        <title>Skills | Mousmit Seth</title>
        <meta 
          name="description" 
        ...
        <meta 
          name="keywords" 
          content={`Mousmit Seth skills, ${technicalSkills.map(s => s.name).join(', ')}, web development skills, programming skills, technical expertise, professional skills`}
        />
        ...
        <meta property="og:title" content="Skills & Expertise | Mousmit Seth" />
        <meta 
        ...
        <meta property="og:image:alt" content="Mousmit Seth Skills Overview" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://amreshbhuyan.com/skills" />
        <meta property="twitter:title" content="Skills | Mousmit Seth - Development Expertise" />
        <meta 
