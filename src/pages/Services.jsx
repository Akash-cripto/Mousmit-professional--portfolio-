...
function Services() {
  ...
  const metaDescription = `Professional services by Mousmit Seth including ${services.map(s => s.category).join(', ')}. Offering enterprise-grade solutions in web, mobile, AI, and security.`;
  ...
  return (
    <>
      <Helmet>
        <title>Services | Mousmit Seth - Web, Mobile, AI & Security Solutions</title>
        <meta 
          name="description" 
        ...
        <meta 
          name="keywords" 
          content={`Mousmit Seth services, ${allKeywords}, web development, mobile app development, AI solutions, cybersecurity, training, mentorship`}
        />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://amreshbhuyan.com/services" />
        <meta property="og:title" content="Professional Services | Mousmit Seth" />
        <meta 
        ...
        <meta property="og:image:alt" content="Mousmit Seth Services Overview" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://amreshbhuyan.com/services" />
        <meta property="twitter:title" content="Services | Mousmit Seth - Development & AI Solutions" />
        <meta 
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Service",
            "name": "Mousmit Seth Development Services",
