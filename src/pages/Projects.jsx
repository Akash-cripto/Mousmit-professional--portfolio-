...
function Projects() {
  ...
  const metaDescription = `Professional projects by Mousmit Seth including ${projects.slice(0, 3).map(p => p.title).join(', ')} and more. Explore enterprise solutions, AI systems, and research publications.`;

  return (
    <>
      <Helmet>
        <title>Projects by Mousmit Seth | Web Development & AI Systems</title>
        <meta 
          name="description" 
        ...
        <meta 
          name="keywords" 
          content="Mousmit Seth projects, web development projects, AI systems, React projects, enterprise solutions, library management system, signature verification, research publications"
        />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://amreshbhuyan.com/projects" />
        <meta property="og:title" content="Projects by Mousmit Seth | Web Development & AI Systems" />
        <meta 
        ...
        <meta property="twitter:title" content="Projects by Mousmit Seth | Web Development & AI Systems" />
        <meta 
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "ItemList",
            "name": "Projects Portfolio - Mousmit Seth",
            "description": "Collection of professional projects and contributions by Mousmit Seth",
